...
public class SingleTopActivity extends DataBindActivity<LaunchModeActStartBinding> {
	@Override
	...
	protected void initData() {
		...
		vm.label.set(SingleTopActivity.class.getSimpleName() +"--singletop--" + getIntent().getFlags());
		mDataBind.setVm(vm);
	}
