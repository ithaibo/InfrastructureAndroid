...
public class SingleInstanceActivity extends DataBindActivity<LaunchModeActStartBinding> {
	@Override
	...
	protected void initData() {
		...
		vm.label.set(SingleInstanceActivity.class.getSimpleName() +"--singleinstance--" + getIntent().getFlags());
		mDataBind.setVm(vm);
	}
