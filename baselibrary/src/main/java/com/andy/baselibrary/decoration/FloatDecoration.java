...
public class FloatDecoration extends RecyclerView.ItemDecoration {
         ...
         */
        public FloatDecoration(Context context, @DrawableRes int drawableId) {
         ...
         */
        public FloatDecoration(Context context, @ColorInt int color, @Dimension float dividerWidth, @Dimension float dividerHeight) {
